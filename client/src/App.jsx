   ...
   return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors">
         <div className="container mx-auto px-4 py-8">
            ...
            <h1 className="text-3xl font-bold text-center text-gray-900 dark:text-white mb-8">Vite + React</h1>
            ...
            <p className="text-center text-gray-600 dark:text-gray-400">Click on the Vite and React logos to learn more</p>
         </div>
      </div>
   );
}
